...
func NewCPU() *pb.CPU {
	...
	numberThreads := randomInt(numberCores, 2*numberCores)
...
func NewGPU() *pb.GPU {
	...
	minGhz := randomFloat64(1.0, 3.5)
	maxGhz := randomFloat64(minGhz, 2.0)

	memory := &pb.Memory{
		Value: uint64(randomInt(2, 10)),
...
func NewLaptop() *pb.Laptop {
	...
	laptop := &pb.Laptop{
		...
		Weight:      &pb.Laptop_WeightKg{WeightKg: randomFloat64(1.0, 30)},
